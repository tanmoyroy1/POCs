...
export class HomePage {
      ...
      // Imgur client ID
      public IMGUR_CLIENT_ID:string = "f85bfc338639986";
      ...
      // Azure Face API key
      public AZURE_API_KEY:string = "bf56862d42a84958b56a07c0d45ac95b";
      ...
      constructor(private navCtrl: NavController, private camera:Camera, public alertCtrl: AlertController) {}
      ...
      public analyzeViaAzure(link:string, analysisCallback:Function = null, failureCallback:Function = null):void {
            ...
            let serialize = (parameters:object) => {
      ...
      public addPerson():void {
            let basicAlert = this.alertCtrl.create({
                  title: 'Personal ID Submitted',
                  subTitle: 'Thanks for submitting your personal ID. It will help us to serve you better.',
                  buttons: ['OK']
            });
      ...
      public analyzeFaceDetails(response:object, analyzeCallback:Function = null, failureCallback:Function = null):void {
            ...
            // analysis list.
            let getAnalysisObject = (feature:string, value:string) => {
